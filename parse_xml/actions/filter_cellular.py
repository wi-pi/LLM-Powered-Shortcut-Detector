...
def action_filter_cellular(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Cellular Plan', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
