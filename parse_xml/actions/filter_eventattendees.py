...
def action_filter_eventattendees(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Calendar Events', 'Condition': 'All of the following are true', 'Filter List': ['Start Date is in the next 7 days'], 'Sort by': 'None', 'Limit': False}, None)
    ...
    if input_text is None:
        input_text = 'All Calendar Events'
