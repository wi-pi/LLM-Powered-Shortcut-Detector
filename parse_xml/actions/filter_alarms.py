...
def action_filter_alarms(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Alarms', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
