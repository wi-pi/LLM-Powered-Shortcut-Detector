...
def action_filter_health_quality(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Health Samples', 'Condition': 'All of the following are true', 'Filter List': ['Type is Steps', 'Start Date is in the last 7 days'], 'Unit': 'count', 'Group by': 'None','Sort by': 'None', 'Limit': False}, None)
