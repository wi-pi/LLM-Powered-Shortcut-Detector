...
def action_filter_tabgroup(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Tab Group', 'Condition': 'All of the following are true', 'Filter List': [], 'Unit': 'count', 'Group by': 'None','Sort by': 'None', 'Limit': False}, None)
