...
def action_filter_reminders(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Remainders', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
