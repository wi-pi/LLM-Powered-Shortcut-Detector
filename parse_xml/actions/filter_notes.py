...
def action_filter_notes(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Notes', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
