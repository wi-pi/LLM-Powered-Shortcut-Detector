...
def action_filter_contacts(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Contacts', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
