...
def action_filter_readinglist_item(elem):
    if not helper.check_validation(elem):
        return helper.append_data({'Find': 'All Reading List Item', 'Condition': 'All of the following are true', 'Filter List': [], 'Sort by': 'None', 'Limit': False}, None)
    ...
    if input_text is None:
        input_text = 'All Reading List Item'
